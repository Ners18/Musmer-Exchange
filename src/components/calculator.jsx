...
function Calculator() {
  ...
  return (
      ...
      <div className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card">
        <div className="bg-gray-900 rounded-[20px] py-5 px-12 min-h-[180px] md:px-2 flex justify-evenly items-center flex-col">
        <div className="w-full  p-[10px] rounded-[20px] ">
      ...
      <div className=" w-full flex text-center justify-center p-3">
        
        {`Changing from ${inputCurrency} to ${outputCurrency}`}
      </div>
        </div>
      </div>
    </div>
